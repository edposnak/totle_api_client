...
SYM_TO_NAME = {
    ...
    'curvefi bbtc': 'CurveFi BBTC',
    'curvefi obtc': 'CurveFi oBTC',
    'curvefi pbtc': 'CurveFi pBTC',
    'curvefi sbtc': 'Curve.fi sBTC',
    'curvefi hbtc': 'Curve.fi hBTC',
    'curvefi linkusd': 'CurveFi LINKUSD',
    'curvefi tbtc': 'Curve.fi tBTC',
    'curvefi ust': 'CurveFi UST',
    'curvefi 3pool': 'Curve.fi 3pool',
    'curvefi dusd': 'CurveFi dUSD',
    'curvefi euro': 'CurveFi EURO',
    ...
    'one_inch_lp_1_1': 'ONE_INCH_LP_1_1',
    'paradex': 'Paradex',
