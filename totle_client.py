...
#                 'Curve.fi Aave': 'CurveFi Aave', 'Curve.fi Compound': 'CurveFi Compound', 'Curve.fi Pool #1': 'CurveFi Pool #1', 'Curve.fi Pool #2': 'CurveFi Pool #2', 'Curve.fi Pool #3': 'CurveFi Pool #3', 'Curve.fi 3pool': 'Curve.fi 3pool',
#                 'Curve.fi USDT': 'CurveFi USDT', 'Curve.fi Y': 'CurveFi Y', 'Curve.fi PAX': 'CurveFi Pax', 'Curve.fi sUSDV2': 'CurveFi sUSDV2',
#                 'Curve.fi renBTC': 'CurveFi Ren', 'Curve.fi sBTC': 'CurveFi sBTC', 'Curve.fi oBTC': 'Curve.fi oBTC', 'Curve.fi pBTC': 'Curve.fi pBTC',
...
#                 'CurveFi USDK': 'CurveFi USDK',  'CurveFi USDN': 'CurveFi USDN', 'Curve.fi UST': 'Curve.fi UST', 'CurveFi RSV': 'CurveFi RSV', 'DODO': 'DODO', 'Curve.fi Euro': 'Curve.fi Euro',
